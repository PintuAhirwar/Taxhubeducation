                ...
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
                    <div className={`col-span-12 ${isProd ? 'bg-newsletter-bg-2' : 'bg-newsletter-bg'} bg-contain bg-no-repeat`}>
                        <div className="mb-10 mt-24 lg:mx-64 lg:my-24">
                            ...
                            <div>
                                <div className="relative text-black flex flex-row-reverse rounded-full pt-5 lg:pt-0">
                                    <input
                                        type="email"
                                        name="q"
                                        className="py-6 lg:py-8 text-sm md:text-lg w-full mx-3 text-black rounded-full pl-8 focus:outline-none bg-white placeholder-gray-500"
                                    ...
                                    <div className="absolute inset-y-0 right-0 flex items-center pr-6 pt-5 lg:pt-0">
                                        <button
                                            type="submit"
                                            className="p-3 lg:p-5 focus:outline-none focus:shadow-outline bg-white hover:bg-gray-200 duration-150 ease-in-out rounded-full"
                                        >
