        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className='col-span-4 md:col-span-4 lg:col-span-4'>
            <div className="flex items-center gap-2">
              ...
              />
              <h5 className="text-lg text-black/60">Indore (M.P.) 452010</h5>
            </div>
            <div className="flex gap-2 mt-10">
              <Icon
                ...
                className="text-primary text-3xl inline-block me-2"
              />
              <h5 className="text-lg text-black/60">+91 88713 09015</h5>
            </div>
            <div className="flex gap-2 mt-10">
              <Icon
                icon="tabler:folder"
                className="text-primary text-3xl inline-block me-2"
              />
              <h5 className="text-lg text-black/60">Taxhubeducation@gmail.com</h5>
            </div>
          </div>
        </div>

        <div className='mt-10 lg:flex items-center justify-between'>
          <h4 className='text-black/50 text-sm text-center lg:text-start font-normal'>@2025. All Rights Reserved by <Link href="TaxhubEducation.com" target="_blank" className="hover:text-primary"> TaxhubEducation</Link></h4>
          ...
          <h4 className='text-black/50 text-sm text-center lg:text-start font-normal'>Developed by <Link href="https://github.com/PintuAhirwar" target="_blank" className="hover:text-primary"> PintuAhirwar</Link></h4>
        </div>
      </div>
    </footer>
  )
